...
function LoginForm() {
  ...
  const handleSubmit = (e) => {
    ...
    // Account = CSC666@ntust.pokémon.master.edu.tw
    // pwd = 12345678
      ...
      <div className="flex overflow-hidden flex-col grow justify-center items-center px-20 py-28 w-full text-base font-bold bg-white rounded-[40px] max-md:px-5 max-md:py-24 max-md:max-w-full">
        ...
        >
          ...
          <button 
            ...
            type="button"
            className="flex items-center justify-center gap-2 mt-6 active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out transform py-4 rounded-xl text-gray-700 font-semibold text-lg border-2 border-gray-100"
          >
