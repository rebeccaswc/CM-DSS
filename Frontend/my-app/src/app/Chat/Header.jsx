...
import { UserCircleIcon, ArrowBigLeftIcon } from "@heroicons/react/24/solid";
  ...
  return (
    <header className="flex overflow-hidden flex-wrap gap-5 justify-between items-start px-6 py-3 w-full text-xs font-medium text-center whitespace-nowrap bg-slate-800 max-md:px-5 max-md:max-w-full">
      <div className="flex gap-2">
        <button className="p-1 bg-indigi-300 bg-[#49495C] rounded-full">
          <ArrowLeft className="w-3 h-3" />
        </button>
        <div className="px-4 py-1  text-sm bg-gradient-to-b from-[#B945DF] to-[#642579] rounded-full max-md:px-5">FIG-121</div>
      </div>
